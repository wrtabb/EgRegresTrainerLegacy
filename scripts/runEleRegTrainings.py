...
def main():
    ...
    input_ideal_ic  = "{}/DoubleElectron_FlatPt-1To500_13p6TeV_Run3Winter22DR-FlatPU0to70ECALIdeal_122X_mcRun3_2021_realistic_v9_ECALIdealIC-v3_AODSIM.root".format(args.input_dir)
    input_real_ic  = "{}/DoubleElectron_FlatPt-1To500_13p6TeV_Run3Winter22DR-FlatPU0to70_122X_mcRun3_2021_realistic_v9-v2_AODSIM.root".format(args.input_dir)
    ...
    regArgs.out_dir = "regressions/Run3ExtendedEtaEle_ideal_and_real" 
    regArgs.ntrees = 1500  
